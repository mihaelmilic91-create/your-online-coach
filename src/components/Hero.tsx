      ...
      <div className="container mx-auto px-4 pt-8 lg:pt-16">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            >
              <a href="https://www.swissmadesoftware.org" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity inline-block relative z-10 cursor-pointer">
                <img
          ...
          >
            ...
            >
              <p className="font-display text-lg sm:text-xl font-bold text-accent">+CHF 360.–</p>
              <p className="text-xs sm:text-sm text-muted-foreground">durchschnittlich gespart</p>
              <p className="text-xs text-muted-foreground/60 mt-0.5">~4 Fahrlektionen à CHF 90.–</p>
            </motion.div>
          </motion.div>
        </div>
      </div>
